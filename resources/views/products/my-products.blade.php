...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6 text-gray-800">My Items for Sale</h1>
    ...
    @if ($products->isEmpty())
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-6 rounded-lg" role="alert">
            ...
            <p>Click <a href="{{ route('products.create') }}" class="text-blue-600 hover:underline">here</a> to list your first item for sale.</p>
        </div>
    @else
                    ...
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                ...
                                <form action="{{ route('products.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this listing?')" class="inline">
                                    @csrf
                                    @method('DELETE')
